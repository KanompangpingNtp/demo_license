            ...
            <div class="card-body">
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-5 mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="confirm_option" id="confirm_food_selling" value="จัดตั้งสถานที่จำหน่ายอาหาร" @checked(old('confirm_option', $form["details"]->confirm_option ?? '') == '1') disabled>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="confirm_option" id="confirm_food_storage" value="จัดตั้งสถานที่สะสมอาหาร" @checked(old('confirm_option', $form['details']->confirm_option ?? '') == '2') disabled>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option1" id="option1" @if(in_array("option1", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option2" id="option2" @if(in_array("option2", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option3" id="option3" @if(in_array("option3", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option4" id="option4" @if(in_array("option4", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option5" id="option5" @if(in_array("option5", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option6" id="option6" @if(in_array("option6", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option7" id="option7" @if(in_array("option7", $form['details']->document_option)) checked @endif disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option8" id="option8" @if(in_array("option8", $form['details']->document_option)) checked @endif disabled>
