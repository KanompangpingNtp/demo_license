                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option1" id="option1" @if(in_array("option1", $form->details->first()->document_option)) checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option2" id="option2" @if(in_array("option2", $form->details->first()->document_option)) checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option3" id="option3" @if(in_array("option3", $form->details->first()->document_option)) checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option4" id="option4" @if(in_array("option4", $form->details->first()->document_option)) checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option5" id="option5" @if(in_array("option5", $form->details->first()->document_option)) checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option6" id="option6" @if(in_array("option6", $form->details->first()->document_option)) checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option7" id="option7" @if(in_array("option7", $form->details->first()->document_option)) checked @endif>
                                ...
                                <!-- Checkbox -->
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="document_option[]" value="option8" id="option8" @if(in_array("option8", $form->details->first()->document_option)) checked @endif>
                        ...
                        @if(in_array(" option8", $form->details->first()->document_option)) block @else none @endif;">
                                    ...
                                    <input type="text" class="form-control" id="document_option_detail" name="document_option_detail" value="{{ old('document_option_detail', $form->details->first()->document_option_detail) }}">
                                </div>
                            </div>
                        </div>
                    </div>
