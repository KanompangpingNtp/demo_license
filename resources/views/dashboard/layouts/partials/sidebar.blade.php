...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text">แบบคำร้องใบอนุญาตสะสมอาหาร</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text">แบบคำร้องใบอนุญาตประกอบกิจการที่เป็นอันตรายต่อสุขภาพ</span></li>

        <li class="menu-item {{ request()->is('admin/health_hazard_applications*') ? 'active open' : '' }}">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class='menu-icon tf-icons bx bx-folder'></i>
                <div data-i18n="User interface" class="text-truncate">แบบคำร้องใบอนุญาตประกอบกิจการที่เป็นอันตรายต่อสุขภาพ</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ request()->is('admin/health_hazard_applications/showdata') ? 'active' : '' }}">
                    <a href="{{route('HealthHazardApplicationAdminShowData')}}" class="menu-link">
                        <div>รับเรื่อง</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->is('admin/health_hazard_applications/appointment') ? 'active' : '' }}">
                    <a href="{{route('HealthHazardApplicationAdminAppointment')}}" class="menu-link">
                        <div>การนัดหมาย</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->is('admin/health_hazard_applications/explore') ? 'active' : '' }}">
                    <a href="{{route('HealthHazardApplicationAdminExplore')}}" class="menu-link">
                        <div>ออกสำรวจ</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->is('admin/health_hazard_applications/payment') ? 'active' : '' }}">
                    <a href="{{route('HealthHazardApplicationAdminPayment')}}" class="menu-link">
                        <div>ชำระเงิน</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->is('admin/health_hazard_applications/approve') ? 'active' : '' }}">
                    <a href="{{route('HealthHazardApplicationAdminApprove')}}" class="menu-link">
                        <div>ออกใบอนุญาต</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->is('admin/health_hazard_applications/expire') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ request()->is('user-account/food_storage_license*') ? 'active open' : '' }}">
         ...
         <li class="menu-item {{ request()->is('user-account/health_hazard_applications*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->is('user-account/health_hazard_applications') ? 'active' : '' }}">
                    <a href="{{route('HealthHazardApplicationFormPage')}}" class="menu-link">
                        <div>ฟอร์ม</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->is('/user-account/health_hazard_applications/show-details') ? 'active' : '' }}">
